        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link" href="javascript:show_AlumnoIndex()" aria-haspopup="true" aria-expanded="false">Alumnos</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link" href="javascript:show_DocenteIndex()" aria-haspopup="true"
                       aria-expanded="false">Docentes</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link" href="javascript:show_CursoIndex()" aria-haspopup="true" aria-expanded="false">Cursos</a>
                </li>
            </ul>
...
<main role="main" style="padding-top: 25px;">
    ...
    <div class="jumbotron" id="divPrincipal">
        <div class="container">
            <h1 class="display-3">Panel Alumno(a)</h1>
